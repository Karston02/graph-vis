...
import ForceDirected from './layouts/force-directed-layout';
/**
  @author David Piegza
 ...
 */
  ...
  Drawing.SimpleGraph = function(options) {
    ...
    function createGraph() {
      ...
      graph.layout = new ForceDirected(graph, that.layout_options);
      graph.layout.init();
    ...
    function drawEdge(source, target) {
        ...
        const line = new THREE.LineSegments( tmp_geo, material );
